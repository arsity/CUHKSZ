...
class Scorecard:
    ...
    def output_verbose(self):
        ...
        print("Chunk info:")
        for chunk in self.chunk_info:
            print("number: " + str(chunk['number']) + ", time chosen :" + str(
                chunk["time"]) + ", bitrate: " + str(chunk["chunk"][0]) + ", actual size: " + str(
                chunk['chunk'][1]))
        ...
        for switch in self.switches:
            print("time chosen: " + str(switch["time"]) + ", previous bitrate: " + str(
                switch["prev_br"]) + ", new bitrate: " + str(switch["post_br"]))
