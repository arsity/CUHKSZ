...
class GFileChooser {
 public:
   ...
   */
  static std::string showOpenDialog(const std::string &title = "Open file",
   ...
   * @param fileFilter a file filter string such as "*.gif,*.jpg,*.png".
   */
  static std::string showOpenDialog(GWindow* parent,
   ...
   * @param fileFilter a file filter string such as "*.gif,*.jpg,*.png".
   */
  static std::string showOpenDialog(QWidget* parent,
                                    const std::string &title = "Open file",
                                    const std::string &currentDir = "",
                                    const std::string &fileFilter = "");
   ...
   * @param fileFilter a file filter string such as "*.gif,*.jpg,*.png".
   */
  static std::string showSaveDialog(const std::string &title = "Save file",
                                    const std::string &currentDir = "",
                                    const std::string &fileFilter = "");
   ...
   * @param fileFilter a file filter string such as "*.gif,*.jpg,*.png".
   */
  static std::string showSaveDialog(GWindow* parent,
   ...
   * @param fileFilter a file filter string such as "*.gif,*.jpg,*.png".
   */
  static std::string showSaveDialog(QWidget* parent,
                                    const std::string &title = "Save file",
                                    const std::string &currentDir = "",
                                    const std::string &fileFilter = "");
