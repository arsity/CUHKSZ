...
class HashMap {
 ...
 public:
  ...
  using const_iterator = stanfordcpplib::collections::ProjectingIterator<stanfordcpplib::collections::CheckedIterator<
      typename std::unordered_map<KeyType, ValueType, Hasher>::const_iterator>>;
...
std::istream &operator>>(std::istream &is,
  ...
  KeyType key;
  ValueType value;
  return stanfordcpplib::collections::readMap(is,
                                              map,
                                              key,
                                              value, /* descriptor */
